      ...
      <div className="intro home-compnt">
        ...
        <div className="intro-section">
          ...
          <p>
            ...
            React.js, Redux, React-Router, CSS and Sass. I am always excited to
            expand this list of skills through learning and studying more. Feel
            free to download a copy of my CV below and get in touch.
          </p>
          <CVDownload>
